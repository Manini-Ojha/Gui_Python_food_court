...
# Create buttons
show_menu_button = tk.Button(root, text="Show Menu", command=lambda: show_menu(category_listbox))
add_to_order_button = tk.Button(root, text="Add to Order", command=lambda: add_to_order(menu_listbox, quantity_entry))
